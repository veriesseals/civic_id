...
class IDApplicationViewSet(viewsets.ModelViewSet):
    ...
    # The serializer_class specifies the serializer that will be used to convert the IDApplication objects to and from JSON format. This allows us to easily serialize and deserialize our data when interacting with the API.
    # ---------------------------------------------------------------
